...
def read_aclImdb(src_path='/data/datasets/aclImdb_raw/',data_type='train'):
...
def make_json_file(ori_sen,label,dst_path='/data/datasets/aclImdb/',data_type='train'):
    if MODE == 'test':
        ori_sen = ori_sen[:30]
...
preprocess('aclImdb','/data/datasets/aclImdb/')
end_time = time.time()
