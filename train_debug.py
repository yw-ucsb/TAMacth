"""
This is used for debugging with console;
"""
...
if __name__ == "__main__":
    ...
    cfg_path = 'config/usb_cv/tamatch/tamatch_cifar100_200_0.yaml'
    ...
    #
    # ulb = model.dataset_dict['train_ulb'].data
    # u_aug = model.dataset_dict['train_ulb'].strong_transform
    #
    # u_loader = model.loader_dict['train_ulb']
