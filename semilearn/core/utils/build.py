...
def get_dataset(args, algorithm, dataset, num_labels, num_classes, data_dir='./data', include_lb_to_ulb=True):
    ...
    # CV: calibration dataset is split (class balanced if possible) from labeled dataset;
    if algorithm == 'confmatch_cv':
        ...
        # Otherwise calibration will be evenly sampled for each class;
            ...
            # print('Calibration idx:', cali_idx)
            # print('Labled idx:', labeled_idx)
    ...
    # NLP or Audio tasks: calibration dataset is the evaluation dataset available;
    elif algorithm == 'confmatch_nlp' or algorithm == 'confmatch_audio':
